    ...
    return (
        <div className="app-background">
            <div className="container mx-auto p-4 px-60 pt-10">
                ...
                {/* Toolbar */}
                <div
                    className="space-y-4 sm:space-y-0 sm:flex sm:flex-wrap sm:items-center sm:gap-4 mb-4 bg-gray-100 rounded-md p-5">
                ...
                <div>
                    {filteredReviews.map(review => (
                        <ReviewCard onEdit={onEditReview} onDelete={onDeleteReview} key={review.id} review={review}/>
                    ))}
